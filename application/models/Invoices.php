...
echo $this->db->last_query();
  ...
  //  echo $row['expense_packing_id'];
       $this->session->set_userdata("sale_p_1",$row['expense_packing_id']);
  ...
  //echo $this->db->last_query();echo "<br/>";
   ...
   //     echo  $purchase_id;
        $this->session->set_userdata("sale_p_2",$purchase_id);
            ...
            for ($i = 0; $i < $rowCount; $i++) {
              ...
              //  $bundlee =$bundle[$i];
                ...
                $data1 = array(
                    ...
                    'expense_packing_id'        =>$this->session->userdata("sale_p_2"),
                    'serial_no'         => $serial,
                    'bundle_ref'               => $bun_reff,
                   'product_name' =>$p_name,
                    'product_id' => $p_id,
