...
<?php  foreach($invoice_detail as $p_info){ ?>
    <tr>
         <td class="wt">
    ...
    <div class="col-sm-6">
            ...
            <select name="product_name[]" id="product_name_1" class="form-control product_name" onchange="product_detail(1);" required  style="width: 250px;">
                ...
                <option value="<?php  echo $p_info['product_name']; ?>"><?php  echo $p_info['product_name']; ?></option>
                 ...
                 <?php foreach ($get_invoice_product as $pack) {?>
...
<tfoot>
    <tr>
        ...
        <td class="text-right">
            <input type="text" id="Total" class="text-right form-control" name="total" value="<?php  echo $invoice[0]['grand_total_amount']; ?>" readonly="readonly" />
        </td>
