...
<?php
    ...
    <div class="col-sm-5" style="color:white;font-weight:bold;" id='company_info'>
       ...
       <div class="col-sm-5 text-center" style="text-align:center;color:white;"><h3><?php echo $header; ?></h3></div>
       <div class="col-sm-2" style="text-align:center;"><img src="<?php echo  base_url().'assets/'.$logo; ?>" style='width: 50%;'>
            ...
            <div class="col-6">
           <table id="one" >
<tr><td  class="key">Trucking Invoice No</td><td style="width:10px;">:</td><td calss="value"><?php echo $invoice_no;  ?></td></tr>
...
<tr><td  class="key">Shipment / BL Number</td><td style="width:10px;">:</td><td calss="value"><?php echo  $shipment_bl_number; ?></td></tr>
</table>
...
<tr><td  class="key">Shipment / BL Number</td><td style="width:10px;">:</td><td calss="value"><?php echo  $shipment_bl_number; ?></td></tr>
        ...
        <div class="body-section">
            <table class="table-bordered">
                ...
                <tr>
                        <td colspan="6" style="text-align:right;font-weight:bold;">Total:</td>
                        <td style="font-size: 16px;"><?php  echo $currency." ".$purchase_all_data[0]['total_amt']; ?></td>
                    </tr>
                    <tr>
                    <td colspan="6" style="text-align:right;font-weight:bold;"><?php echo  "Tax (".$tax_des;  ?></td>
                           <td style="font-size: 16px;"><?php  echo $currency." " ; ?><?php echo $tax_amt;  ?></td>
