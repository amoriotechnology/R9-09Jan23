...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <input type="text" tabindex="3" class="form-control" name="gross_weight" readonly value="{gross_weight}" placeholder="Gross Weight" id="gross_wight" />
            </div>
        </div>
    </div>
   ...
   <div class="row">
    <div class="col-sm-6">
       <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control"  id="adress" value="<?php  echo $p_info['remarks']; ?>" name="remarks" placeholder="Remarks" />
            </div>
